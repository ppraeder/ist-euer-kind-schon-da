 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class it{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((e,n)=>{this.resolve=e,this.reject=n})}wrapCallback(e){return(n,r)=>{n?this.reject(n):this.resolve(r),typeof e=="function"&&(this.promise.catch(()=>{}),e.length===1?e(n):e(n,r))}}}function Ae(){return typeof indexedDB=="object"}function ot(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var a;e(((a=s.error)===null||a===void 0?void 0:a.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=on;function dn(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:Ne,automaticDataCollectionEnabled:!1},e),r=n.name;if(typeof r!="string"||!r)throw v.create("bad-app-name",{appName:String(r)});const s=$.get(r);if(s){if(Z(t,s.options)&&Z(n,s.config))return s;throw v.create("duplicate-app",{appName:r})}const a=new wt(r);for(const o of ne.values())a.addComponent(o);const i=new un(t,n,a);return $.set(r,i),i}function gn(t=Ne){const e=$.get(t);if(!e)throw v.create("no-app",{appName:t});return e}function _(t,e,n){var r;let s=(r=cn[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const a=s.match(/\s|\//),i=e.match(/\s|\//);if(a||i){const o=[`Unable to register library "${s}" with version "${e}":`];a&&o.push(`library name "${s}" contains illegal characters (whitespace or "/")`),a&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),T.warn(o.join(" "));return}R(new S(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pn="firebase-heartbeat-database",mn=1,F="firebase-heartbeat-store";let K=null;function Be(){return K||(K=Re(pn,mn,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(F)}}}).catch(t=>{throw v.create("idb-open",{originalErrorMessage:t.message})})),K}async function bn(t){var e;try{return(await Be()).transaction(F).objectStore(F).get(Pe(t))}catch(n){if(n instanceof w)T.warn(n.message);else{const r=v.create("idb-get",{originalErrorMessage:(e=n)===null||e===void 0?void 0:e.message});T.warn(r.message)}}}async function be(t,e){var n;try{const s=(await Be()).transaction(F,"readwrite");return await s.objectStore(F).put(e,Pe(t)),s.done}catch(r){if(r instanceof w)T.warn(r.message);else{const s=v.create("idb-set",{originalErrorMessage:(n=r)===null||n===void 0?void 0:n.message});T.warn(s.message)}}}function Pe(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Le=1e4,$e=`w:${oe}`,ke="FIS_v2",vn="https://firebaseinstallations.googleapis.com/v1",An=60*60*1e3,Dn="installations",Mn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function he(t,e=!1){let n;const r=await j(t.appConfig,a=>{if(!Xe(a))throw A.create("not-registered");const i=a.authToken;if(!e&&Qn(i))return a;if(i.requestStatus===1)return n=Xn(t,e),a;{if(!navigator.onLine)throw A.create("app-offline");const o=tr(a);return n=Zn(t,o),o}});return n?await n:r.authToken}async function Xn(t,e){let n=await Ie(t.appConfig);for(;n.authToken.requestStatus===1;)await qe(100),n=await Ie(t.appConfig);const r=n.authToken;return r.requestStatus===0?he(t,e):r}function Ie(t){return j(t,e=>{if(!Xe(e))throw A.create("not-registered");const n=e.authToken;return nr(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function Zn(t,e){try{const n=await Yn(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return await k(t.appConfig,r),n}catch(n){if(xe(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Ye(t.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await k(t.appConfig,r)}throw n}}function Xe(t){return t!==void 0&&t.registrationStatus===2}function Qn(t){return t.requestStatus===2&&!er(t)}function er(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+An}function tr(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function nr(t){return t.requestStatus===1&&t.requestTime+Le<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ar=60*1e3,Dr=12*60*60*1e3;class Mr{constructor(e,n,r,s,a){this.app=e,this._client=n,this._storageCache=r,this._storage=s,this._logger=a,this._isInitializationComplete=!1,this.settings={fetchTimeoutMillis:Ar,minimumFetchIntervalMillis:Dr},this.defaultConfig={}}get fetchTimeMillis(){return this._storageCache.getLastSuccessfulFetchTimestampMillis()||-1}get lastFetchStatus(){return this._storageCache.getLastFetchStatus()||"no-fetch-yet"}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fr(){R(new S(Qe,t,"PUBLIC").setMultipleInstances(!0)),_(Y,ye),_(Y,ye,"esm2017");function t(e,{instanceIdentifier:n}){const r=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();if(typeof window>"u")throw d.create("registration-window");if(!Ae())throw d.create("indexed-db-unavailable");const{projectId:a,apiKey:i,appId:o}=r.options;if(!a)throw d.create("registration-project-id");if(!i)throw d.create("registration-api-key");if(!o)throw d.create("registration-app-id");n=n||"firebase";const l=new Br(o,r.name,n),c=new Pr(l),u=new De(Y);u.logLevel=h.ERROR;const f=new Cr(s,fn,n,a,i,o),p=new vr(f,l),m=new Ir(p,l,c,u),g=new Mr(r,m,c,l,u);return wr(g),g}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lr(t){return t=N(t),await Er(t),_r(t)}Fr();const $r=require("canvas-confetti"),kr="#"+((1<<24)*Math.random()|0).toString(16),xr={apiKey:"AIzaSyACACC3OqR3vch3_usClwWB0a_18HtRzjM",authDomain:"ist-euer-kind-schon-da.firebaseapp.com",projectId:"ist-euer-kind-schon-da",storageBucket:"ist-euer-kind-schon-da.appspot.com",messagingSenderId:"224820046496",appId:"1:224820046496:web:784f8d0fbe9b35490eb7c5",measurementId:"G-L6EYV8GD8V"},Hr=dn(xr),P=br(Hr);P.settings.minimumFetchIntervalMillis=3600;P.defaultConfig={child_born:!1,born_at:""};document.documentElement.style.setProperty("--main-bg-color",kr);let et="NEIN",se="";Lr(P).then(()=>{Se(P,"child_born").asBoolean()==!0&&(se=Se(P,"born_at").asString(),et="JA",jr(),tt())}).catch(t=>{console.log(t)});tt();function tt(){document.querySelector("#app").innerHTML=`
  <div>
    <h1>${et}<h1>
...
`}function X(t,e){return Math.random()*(e-t)+t}function jr(){$r({angle:X(55,125),spread:X(50,70),particleCount:X(50,100),origin:{y:.6}})}
